Shader "Custom RP/Lit" {
	...
	SubShader {
		...
		HLSLINCLUDE // includes the files at the start of all passes
	...
	CustomEditor "CustomShaderGUI" // tell Unity to make an instance of the given class to draw the material inspector for this shader
}